...
public interface ISQLiteParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterJoin_stmt([NotNull] SQLiteParser.Join_stmtContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="SQLiteParser.join_stmt"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitJoin_stmt([NotNull] SQLiteParser.Join_stmtContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterOffset_clause([NotNull] SQLiteParser.Offset_clauseContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="SQLiteParser.offset_clause"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitOffset_clause([NotNull] SQLiteParser.Offset_clauseContext context);
	/// <summary>
